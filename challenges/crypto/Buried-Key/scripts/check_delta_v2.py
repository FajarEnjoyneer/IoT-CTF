...
def main():
    ...
    for d1 in range(1, 256):
        exp1 = [galois_mul(2, d1), d1, d1, galois_mul(3, d1)]
        for d2 in range(1, 256):
            exp2 = [galois_mul(2, d2), d2, d2, galois_mul(3, d2)]
            ...
            for i in range(4):
                ...
                for k in range(256):
                    ...
                    if sbox[x ^ exp1[i]] == (f1[idx] ^ k) and sbox[x ^ exp2[i]] == (f2[idx] ^ k):
                        found_k = True
                        break
                if found_k: cand_count += 1
            
            if cand_count == 4:
                print(f"Found deltas: d1={d1}, d2={d2}")
                # Print K10 for this
                k10_col = []
                for i in range(4):
                    idx = indices[i]
