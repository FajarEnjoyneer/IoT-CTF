...
# Key recovered via DCA
k10_hex = "1004c25ab2d6748e10426520c3973004"
k10 = bytes.fromhex(k10_hex)
...
# The binary has an internal transformation 'FinalDec'
# We need to invert it based on the binary file data
